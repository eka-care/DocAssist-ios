...
let package = Package(
  ...
  dependencies: [
    ...
    // Medical Record
    .package(url: "git@github.com:eka-care/EkaMedicalRecordsUI.git", branch: "main"),
    // Mixpanel
    .package(url: "https://github.com/mixpanel/mixpanel-swift", from: "3.2.5"),
    // VoiceToRx
    .package(url: "https://github.com/eka-care/EkaVoiceToRx.git", branch: "fix-multiple-v2rx-in-session-not-working"),
    // EkaPDFMaker
