...
let package = Package(
  ...
  dependencies: [
    ...
    // Medical Record
    .package(url: "https://github.com/eka-care/EkaMedicalRecordsUI.git", from: "1.0.14"),
    // Mixpanel
    .package(url: "https://github.com/mixpanel/mixpanel-swift", from: "3.2.5"),
    // VoiceToRx
    .package(url: "https://github.com/eka-care/EkaVoiceToRx.git", revision: "a6d4bb6be95aba3b453a54700abc186d5f11783d"),
    // EkaPDFMaker
