...
extension ChatViewModel {
    ...
    return await withCheckedContinuation { continuation in
      let networkRequest = HTTPNetworkRequest(
        ...
        headers: [
          ...
          "x-agent-id": SetUIComponents.shared.xAgentId ?? "MjRlMjhhOGItZWU5OC00OTk4LTlhYTktZWJkYmVhZDllNmU0IzE3MDE0MjYxMjk4NTU4OA=="
        ],
        body: nil
      )
  ...
  func refreshSession(for sessionId: String) async {
    ...
    let networkRequest = HTTPNetworkRequest(
      url: url,
      method: .post,
      headers: ["Content-Type": "application/json", "x-agent-id": SetUIComponents.shared.xAgentId ?? "MjRlMjhhOGItZWU5OC00OTk4LTlhYTktZWJkYmVhZDllNmU0IzE3MDE0MjYxMjk4NTU4OA=="],
      body: nil
    )
